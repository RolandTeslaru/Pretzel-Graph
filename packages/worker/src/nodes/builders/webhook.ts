...
export namespace WebhookBuilder {
    ...
    >(config: BaseProps<TId, TMethod, TResponseMode>): Ret<TId, TMethod, TResponseMode> {
        return buildBase(config) as Ret<TId, TMethod, TResponseMode>;
    }
    ...
    >(
        ...
        return buildBase({ ...config, method: "GET" }) as Ret<TId, "GET", TResponseMode>;
    }
    ...
    >(
        ...
        return buildBase({ ...config, method: "POST" }) as Ret<TId, "POST", TResponseMode>;
    }
    ...
    >(
        ...
        return buildBase({ ...config, method: "PUT" }) as Ret<TId, "PUT", TResponseMode>;
    }
    ...
    >(
        ...
        return buildBase({ ...config, method: "PATCH" }) as Ret<TId, "PATCH", TResponseMode>;
    }
    ...
    >(
        ...
        return buildBase({ ...config, method: "DELETE" }) as Ret<TId, "DELETE", TResponseMode>;
    }
}