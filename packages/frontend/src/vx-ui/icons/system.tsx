...
const AlertTriangle: React.FC<BaseIconProps> = (props) => (
...
const Minimize2: React.FC<BaseIconProps> = (props) => (
...
const Globe: React.FC<BaseIconProps> = (props) => (
...
const Lambda: React.FC<BaseIconProps> = (props) => (
...
const Ellipsis: React.FC<BaseIconProps> = (props) => (
...
const Comment: React.FC<BaseIconProps> = (props) => (
...
const Download: React.FC<BaseIconProps> = (props) => (
...
const File: React.FC<BaseIconProps> = (props) => (
...
const Trash2: React.FC<BaseIconProps> = (props) => (
...
const CirclePlus: React.FC<BaseIconProps> = (props) => (
...
const Sparkles: React.FC<BaseIconProps> = (props) => (
...
const EyeOff: React.FC<BaseIconProps> = (props) => (
...
const Eye: React.FC<BaseIconProps> = (props) => (
...
const Calendar: React.FC<BaseIconProps> = (props) => (
...
const Archive: React.FC<BaseIconProps> = (props) => (
    <BaseIcon strokeWidth={2} {...props}>
...
const Clock: React.FC<BaseIconProps> = (props) => (
    <BaseIcon strokeWidth={2} {...props}>
        <path d="M12 6v6l4 2"/><circle cx="12" cy="12" r="10"/>
    </BaseIcon>
)
Clock.displayName = "Clock"
const CalendarPlus: React.FC<BaseIconProps> = (props) => (
    <BaseIcon strokeWidth={2} {...props}>
...
//  Filter
const Filter: React.FC<BaseIconProps> = (props) => (
    <BaseIcon strokeWidth={2} {...props}>
...
const Tag: React.FC<BaseIconProps> = (props) => (
    <BaseIcon strokeWidth={2} {...props}>
...
// Volume
const VolumeX: React.FC<BaseIconProps> = (props) => (
    <BaseIcon strokeWidth={2} {...props}>
...
// User round x
const UserRoundX: React.FC<BaseIconProps> = (props) => (
    <BaseIcon strokeWidth={2} {...props}>
...
// Copy
const Copy: React.FC<BaseIconProps> = (props) => (
    <BaseIcon strokeWidth={2} {...props}>
...
// Trash
const Trash: React.FC<BaseIconProps> = (props) => (
    <BaseIcon strokeWidth={2} {...props}>
...
// Bot
const Bot: React.FC<BaseIconProps> = (props) => (
    <BaseIcon strokeWidth={2} {...props}>
...
// Search
const Search: React.FC<BaseIconProps> = (props) => (
    <BaseIcon strokeWidth={2} {...props}>
...
// Star
const Star: React.FC<BaseIconProps> = (props) => (
    <BaseIcon strokeWidth={2} {...props}>
...
// Audio
const Audio: React.FC<BaseIconProps> = (props) => (
    <BaseIcon strokeWidth={2} {...props}>
...
// Bluetooth
const Bluetooth: React.FC<BaseIconProps> = (props) => (
    <BaseIcon strokeWidth={2} {...props}>
...
const MoveVertical: React.FC<BaseIconProps> = (props) => (
    <BaseIcon strokeWidth={2} {...props}>
...
const Folder: React.FC<BaseIconProps> = (props) => (
    <BaseIcon strokeWidth={2} {...props}>
...
const FolderOpen: React.FC<BaseIconProps> = (props) => (
    <BaseIcon strokeWidth={2} {...props}>
...
const FileCode: React.FC<BaseIconProps> = (props) => (
    <BaseIcon strokeWidth={2} {...props}>
...
const ShoppingBag: React.FC<BaseIconProps> = (props) => (
    <BaseIcon strokeWidth={2} {...props}>
...
const Logout: React.FC<BaseIconProps> = (props) => (
    <BaseIcon strokeWidth={2} {...props}>
...
const FileText: React.FC<BaseIconProps> = (props) => (
    <BaseIcon strokeWidth={2} {...props}>
...
const Monitor: React.FC<BaseIconProps> = (props) => (
    <BaseIcon strokeWidth={2} {...props}>
...
const Moon: React.FC<BaseIconProps> = (props) => (
    <BaseIcon strokeWidth={2} {...props}>
...
const Sun: React.FC<BaseIconProps> = (props) => (
    <BaseIcon strokeWidth={2} {...props}>
...
const Pallet: React.FC<BaseIconProps> = (props) => (
    <BaseIcon strokeWidth={2} {...props}>
...
const Layers: React.FC<BaseIconProps> = (props) => (
    <BaseIcon strokeWidth={2} {...props}>
...
const Save: React.FC<BaseIconProps> = (props) => (
    <BaseIcon strokeWidth={2} {...props}>
...
const FolderSearch: React.FC<BaseIconProps> = (props) => (
    <BaseIcon strokeWidth={2} {...props}>
...
const MoveHorizontal: React.FC<BaseIconProps> = (props) => (
    <BaseIcon strokeWidth={2} {...props}>
