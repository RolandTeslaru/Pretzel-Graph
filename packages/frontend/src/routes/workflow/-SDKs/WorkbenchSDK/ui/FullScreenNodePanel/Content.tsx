...
const FullScreenContent = ({ clickedNode }: { clickedNode: Workflow.Node }) => {
  ...
  return (
    <>
      <div className='bg-card/80 w-full  h-full top-0 border-border border rounded-2xl shadow-xl shadow-black/10 backdrop-blur-lg'>
        <IncomingPanel />
      </div>
      ...
      <div className='bg-card/80  h-full w-full border-border border rounded-2xl shadow-xl shadow-black/10 backdrop-blur-lg'>
        <OutgoingPanel />
      </div>
    </>
  )
