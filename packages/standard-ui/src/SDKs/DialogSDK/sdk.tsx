        ...
        return (
            ...
            >
                <Dialog.Content
                    ...
                    onEscapeKeyDown={blockDismiss}
                >
                    <div className={"bg-card/50 rounded-l-2xl backdrop-blur-lg border border-border min-w-[200px] p-4 pt-5 flex flex-col gap-2 " + sidebarClassName} style={{ ...surfaceStyle, ...delayStyle }}>
                        {sidebarRenderer()}
                    </div>
