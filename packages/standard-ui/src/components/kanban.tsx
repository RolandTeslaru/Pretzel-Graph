...
/**
 * Client-mount gate for the `createPortal` call in Overlay, which needs
...
function ColumnContent({
  ...
  const itemIds = useMemo(() => {
    ...
    if (!items) {
      throw new Error(
        `Kanban.ColumnContent: column "${value}" was not found in the Root value. ` +
...
function Overlay({ children, className, ...props }: KanbanOverlayProps) {
