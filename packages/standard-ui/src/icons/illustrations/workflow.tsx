...
// Fills with currentColor; defs are scoped per instance so several can share a page.
export function WorkflowIllustration({ className, ...props }: SVGProps<SVGSVGElement>) {
    const id = useId()
    ...
    return (
        ...
        >
            <defs>
                <linearGradient id={`workflowGlyphFill${id}`} x1="58" y1="35" x2="188" y2="218" gradientUnits="userSpaceOnUse">
                    <stop offset="0" stopColor="currentColor" stopOpacity="0.9" />
                    <stop offset="0.5" stopColor="currentColor" stopOpacity="1" />
                    <stop offset="1" stopColor="currentColor" stopOpacity="1" />
                </linearGradient>

                <linearGradient id={`workflowGlyphGleam${id}`} x1="36" y1="44" x2="168" y2="190" gradientUnits="userSpaceOnUse">
                ...
                <mask id={`workflowGlyphShape${id}`} maskUnits="userSpaceOnUse" x="25" y="39" width="207" height="178">
            ...
            <g>
                <rect
                    ...
                    width="207"
                    height="178"
                    fill={`url(#workflowGlyphFill${id})`}
                    mask={`url(#workflowGlyphShape${id})`}
                />
                <rect
                    x="25"
                    y="39"
                    width="207"
                    height="178"
                    fill={`url(#workflowGlyphGleam${id})`}
                    mask={`url(#workflowGlyphShape${id})`}
                />
            </g>
        </svg>
